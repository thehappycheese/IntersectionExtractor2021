...
| road_direction_deg                           | `gm.radians_to_degrees(current_road_direction)`               | Primary Road      | Direction of the primary road in degrees (SLK direction)                                                                                                                                                                                                                                                                           |
| intersecting_direction                       | `gm.radians_to_degrees(intersecting_road_direction)`          | Intersecting Road | Direction of intersecting road in degrees (SLK direction)                                                                                                                                                                                                                                                                          |
